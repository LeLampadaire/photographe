...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-bar-block w3-black w3-animate-right w3-top w3-text-light-grey w3-large headerNav" id="mySidebar">
    ...
    <a href="/information.php" onclick="w3_close()" class="w3-bar-item w3-button w3-center w3-padding-16">Informations</a> 
